...
define('COOKIES_NAME', 'sikerma_admin');
define('MEMBER_COOKIES_NAME', 'sikerma_member');
 ...
 * BIBLIO INDEXING
 */
$sysconf['index']['type'] = 'sphinx'; // value can be 'default', 'index' OR 'sphinx'
...
$sysconf['ipaccess']['smc-kerjasama'] = 'all';
$sysconf['ipaccess']['smc-mou'] = 'all';
$sysconf['ipaccess']['smc-per_kerjasama'] = 'all';
$sysconf['ipaccess']['smc-foreigner'] = 'all';
...
if (!defined('DB_NAME')) { define('DB_NAME', 'asing'); }
...
// system user type
$sysconf['system_user_type'][1] = ('Librarian');
$sysconf['system_user_type'][2] = ('Senior Librarian');
$sysconf['system_user_type'][3] = ('Library Staff');
