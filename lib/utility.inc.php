...
//})";
    ...
    public static function highlight_string($body_text,$searh_letter){     //function for highlight the word in body of your page or paragraph or string
     ...
     $lword = strlen(trim($searh_letter));    // this is the length of your search string so that you can add it to $pos and start with rest of your string
     ...
     $body = $string0."<font style='color:#FF0000; background-color:yellow;'>".$string1."</font>".$string2;
     return $body;
    }
}
